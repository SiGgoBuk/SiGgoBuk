...
| 프로젝트 | 설명 | 기술 |
|---------|------|------|
| **[EKS 기반 URL 단축기](https://github.com/SiGgoBuk/eks-url-shortener)** | Terraform으로 EKS·RDS·Redis 전체 인프라 구축, ALB Controller·HPA 적용 배포 · **트러블슈팅 7건 문서화** | `EKS` `Terraform` `ECR` `RDS` `Redis` |
...
| **[Multi-Cloud 인프라](https://github.com/SiGgoBuk)** | GCP-AWS HA VPN·BGP 연동 하이브리드 네트워크 (팀장 · 진행중) | `GCP` `AWS` `VPN` |
